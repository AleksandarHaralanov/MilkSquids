...
public class MilkSquids extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        UpdateUtil.checkForUpdates(NAME, VERSION,"https://api.github.com/repos/AleksandarHaralanov/MilkSquids/releases/latest");

        getServer().getPluginManager().registerEvents(new PlayerInteractEntityListener(), this);

        final MilkSquidsCommand milkSquidsCommand = new MilkSquidsCommand(NAME, VERSION, AUTHOR, SOURCE);
        getCommand("milksquids").setExecutor(milkSquidsCommand);
