...
public class MilkSquidsCommand implements CommandExecutor {
    ...
    public MilkSquidsCommand(final String NAME, final String VERSION, final String AUTHOR, final String SOURCE) {
        this.NAME = NAME;
